...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
  ...
  <div class="collapse navbar-collapse" id="navbarNav ">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../masterlist.php">Masterlist List</a>
      </li>
      <li class="nav-item">
    ...
    if (isset($_GET['search'])) {
        ...
        if (mysqli_num_rows($query_run) >
                  ...
                  <?php
                                                ...
                                                ?>
                  <tr>
                  <td colspan="4"><h1 style = "color:red"> No Student Found </h1> 
                  <h5>
       ...
       ?>
          ...
          <a class="link-primary" href="admin_create.php" display-40>
