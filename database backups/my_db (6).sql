...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2023 at 06:53 AM
...
(110, 'ENGLISH', 88, 0, '', '', ''),
(111, 'ENGLISH', 100, 0, '', 'Avril Ramorna Lavigne', '');
...
INSERT INTO `students` (`id`, `lrnnumber`, `firstname`, `middlename`, `lastname`, `fullname`, `suffix`, `gender`, `birthplace`, `birthday`, `age`, `address`, `parent`, `adviser_id`, `schoolyear`, `grade`, `section`, `subject`, `g`) VALUES
(8, 631233931, 'Avril', 'Ramorna', 'Lavigne', 'Avril Ramorna Lavigne', 'Jr.', 'Female', 'Canada', '2023-01-13', 38, 'Reynato Milmao', 'Sto. Nino Kolambugan', 'admin', '2022-2023', 7, 'Lilac', 0, 0),
(127, 17, 'Reyris Gwapo', 'Perolino', 'Milmao', 'Milmao Reyris Perolino', '', 'Male', 'Sto. Nino', '2023-01-13', 22, 'Reynato Milmao', 'Sto. Nino Kolambugan', 'yawa', '2023-2024', 7, 'Rose', 0, 0);
