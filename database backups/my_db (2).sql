...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2023 at 09:03 AM
...
(1, 666, 'Test', 'Test', 'Test', '', 'Male', 'Tests', '2023-01-12', 32, 'Test', 'Test', 'admin', '2022-2023'),
(5, 1, 'dd', 's', 'w', 'jr', 'ew', 'qe2', '', 0, '', '', 'yawa', '2022-2023'),
(34, 0, 'roi', 'Perolinos', 'Milmao', '', 'Male', 'mhvkjg', '2023-02-02', 226, 'mbjk', 'Sto. Nino Kolambugan', 'yawa', '2022-2023');
...
INSERT INTO `year` (`year`, `schoolyear`) VALUES
('2022-2023', '2022-2023');
...
ALTER TABLE `students`
  ...
  ADD CONSTRAINT `year` FOREIGN KEY (`schoolyear`) REFERENCES `year` (`schoolyear`);
