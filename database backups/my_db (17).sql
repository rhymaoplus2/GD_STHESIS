...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2023 at 10:00 AM
...
INSERT INTO `grade` (`id`, `subjectname`, `grade`, `remarks`, `studentname`, `firstname`, `middlename`, `lastname`, `gender`, `teacher`, `section`, `adviser`) VALUES
(501, 'ENGLISH', 65, 'FAILED', 'Finn H. Doria', 'Finn', 'Heriih', 'Doria', 'Female', 'Glitz Wyn Sobisol', 'Lilac', 'teacher'),
(502, 'ENGLISH', 87, 'PASS', 'Shawn Perolino Mendes', 'Shawn', 'Perolino', 'Mendes', 'MALE', 'Glitz Wyn Sobisol', 'LILAC', 'teacher');
