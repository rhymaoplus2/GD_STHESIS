...
<?PHP include_once('header.php');?>
    ...
    <div class="mb-3 text-center text-white" style="	box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius:20px; background-image: linear-gradient(60deg, #29323c 0%, #485563 100%);"> <h3> SELECT SUBJECTS</h3></div>
