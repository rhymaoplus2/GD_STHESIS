...
<div>
    <div style="	box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
     border-radius:20px; background-image: linear-gradient(60deg, #29323c 0%, #485563 100%);" class="text-white text-center"><h4>SHS FIRST QUARTER PRINTABLE GRADES </h4></div>
</div>
...
<div class="table-scrollable">
  ...
  <table class="table table-striped">
    ...
    $query = "SELECT MAX(section) AS section, MAX(year) AS year, MAX(sy) AS sy, MAX(quarter) AS quarter, subjectname, teacher
              FROM grade 
              WHERE quarter='FIRST' AND (year ='11' OR year ='12')
