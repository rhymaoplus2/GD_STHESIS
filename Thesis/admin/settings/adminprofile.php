...
<option value="none" <?= $row['role3'] === 'none' ? 'selected' : '' ?>>None</option>
  ...
  <option value="registrar staff" <?= $row['role3'] === 'registrar staff' ? 'selected' : '' ?>>Registrar Staff</option>
    ...
    <button type="button" class="btn btn-dark" style="background-color: transparent; border: none; border-radius: 100%; width: 50px; height: 50px;" onclick="location.href='users.php'">
