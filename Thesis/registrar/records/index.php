...
function generateNotification() {
    ...
    if ($result) {
      while ($row = $result->fetch_assoc()) {
        ...
        if ($count >= 1) {
            echo "<a hidden style='text-decoration:none;' class='link-primary me-2' href='validate.php' data-bs-toggle='tooltip' data-bs-placement='bottom' data-bs-class='tooltip' title='New Grades to Validate  '>";
            ...
            echo "<a hidden disabled style='text-decoration:none;' class='link-primary me-2' href='#' data-bs-toggle='tooltip' data-bs-placement='bottom' data-bs-class='tooltip' title='Zero Request'>";
            echo "<div style='position: relative; display: inline-block;'>";
            echo "<img style='width: 30px;' src='img/notification.png' class='img-fluid zoom-img'>";
            echo "</div>";
            echo "</a>";
