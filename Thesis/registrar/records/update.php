...
<button title="proceed" type="submit" class="btn btn-primary" 
...
<button title="cancel "  type="button" class="btn btn-danger" style="background-color: transparent; border: none; border-radius: 100%; width: 50px; height: 50px;" onclick="goBack()">
