...
<div>
    <div  style="	box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
     border-radius:20px;   background-image: linear-gradient(to right, #f83600 0%, #f83600 100%);" class="mb-3 text-white text-center"><h4>SHS FOURTH QUARTER PRINTABLE GRADES </h4></div>
</div>  
