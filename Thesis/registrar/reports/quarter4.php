...
<div>
    <div  style="	box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
     border-radius:20px; 
     background-image: radial-gradient( circle farthest-corner at 10% 20%,  rgba(237,3,32,0.87) 20.8%, rgba(242,121,1,0.84) 74.4% );" class="mb-3 text-white text-center"><h4>SHS FOURTH QUARTER PRINTABLE GRADES </h4></div>
</div>  
