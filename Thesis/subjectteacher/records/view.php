  ...
  <div class="b tex" style="height: 300px; overflow-y: scroll; padding-right: 10px;" id="scrollable">
    <table class="table table-bordered table-sm rounded-4" style="border-radius: 10px;">
      <thead class="text-center text-white" style="background-image: linear-gradient(-20deg, #b721ff 0%, #21d4fd 100%);">
        <tr>
          <th scope="col">Choose one Subject to Add Grades</th>
        </tr>
      </thead>
      <tbody>
        <?php
              ...
              <tr>
                ...
                <?php } else { ?>
                  <td class="text-center">
                    <a href="subject1.php" class=" text-dark" style="background-color: white; border: none;">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <?php } else { ?>
                        <td class="text-center">
                          <a href="subject2.php" style="background-color: white; border: none;" class="text-dark">
  ...
  <tbody>
    ...
    ?>
        <tr>
          ...
          <?php } else { ?>
            <td class="text-center">
              <a href="subject3.php" style="background-color: white; border: none;" class="text-dark">
  ...
  <tbody>
    ...
    ?>
        <tr>
          ...
          <?php } else { ?>
            <td class="text-center">
              <a href="subject4.php" style="background-color: white; border: none;" class="text-dark">
  ...
  <tbody>
    ...
    ?>
        <tr>
          ...
          <?php } else { ?>
            <td class="text-center">
              <a href="subject5.php" style="background-color: white; border: none;" class="text-dark">
  ...
  <tbody>
    ...
    ?>
        <tr>
          ...
          <?php } else { ?>
            <td class="text-center">
              <a href="subject6.php" style="background-color: white; border: none;" class="text-dark">
  ...
  <tbody>
    ...
    ?>
        <tr>
          ...
          <?php } else { ?>
            <td class="text-center">
              <a href="subject7.php" style="background-color: white; border: none;" class="text-dark">
  ...
  <tbody>
    ...
    ?>
        <tr>
          ...
          <?php } else { ?>
            <td class="text-center">
              <a href="subject8.php" style="background-color: white; border: none;" class="text-dark">
  ...
  <tbody>
    ...
    ?>
        <tr>
          ...
          <?php } else { ?>
            <td class="text-center">
              <a href="subject9.php" style="background-color: white; border: none;" class="text-dark">
  ...
  <tbody>
    ...
    ?>
        <tr>
          ...
          <?php } else { ?>
            <td class="text-center">
              <a href="subject10.php" style="background-color: white; border: none;" class="text-dark">
