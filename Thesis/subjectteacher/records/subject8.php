...
$i = 0;
    while ($rows = mysqli_fetch_assoc($result)) {
      ...
      <?php
        ...
        WHERE students.syear = (SELECT schoolyear FROM users LIMIT 1)  AND gender = 'MALE' AND (students.subject1 = '".$_SESSION["sub8"]."' OR students.subject2 = '".$_SESSION["sub8"]."' 
        ...
        GROUP BY students.fullname, students.adviser_id, users.sub8,
        students.section, students.firstname, students.middlename,
        students.trackstrand, students.lastname, students.gender,
        students.syear, students.grade, students.id
...
<?php
        ...
        JOIN users ON 
            ...
            OR users.sec7 = students.section OR users.sec8 = students.section OR users.sec9 = students.section 
            OR users.sec10 = students.section)
        WHERE students.syear = (SELECT schoolyear FROM users LIMIT 1)  AND gender = 'FEMALE' AND (students.subject1 = '".$_SESSION["sub8"]."' OR students.subject2 = '".$_SESSION["sub8"]."' 
            OR students.subject3 = '".$_SESSION["sub8"]."' OR students.subject4 = '".$_SESSION["sub8"]."' 
            OR students.subject5 = '".$_SESSION["sub8"]."' OR students.subject6 = '".$_SESSION["sub8"]."' 
            OR students.subject7 = '".$_SESSION["sub8"]."' OR students.subject8 = '".$_SESSION["sub8"]."' 
            OR students.subject9 = '".$_SESSION["sub8"]."' OR students.subject10 = '".$_SESSION["sub8"]."')
