...
<div class="mx-auto text-center text-wrap mb-3 text-white rounded-pill shadow" style="padding: 10px; background-image: linear-gradient(-20deg, #b721ff 0%, #21d4fd 100%);">
  <b style="white-space: nowrap;"> Students Grades in Subject: <?php echo substr($_SESSION['sub5'], 0, 30); ?> </b>
</div>
...
a.name AS user_name, a.sub5 AS user_sub5, a.sec1, a.sgh1, b.remarks, b.quarter, b.semester, b.sy
