...
<head>
  ...
  <script>
		function printPage() {
			window.location.href = "printsubject6.php";
		}
	</script>
...
<form action="./php/subject6create.php"
      method="post" >
  ...
  <script>
    ...
    $name = $_SESSION["name"];
    $query = "SELECT students.fullname, students.adviser_id, users.sub6,
            ...
            WHERE (students.subject6 = users.sub6 OR students.subject2 = users.sub6 OR students.subject3 = users.sub6 OR students.subject4 = users.sub6 OR students.subject5 = users.sub6 OR students.subject6 = users.sub6 OR students.subject7 = users.sub6 OR students.subject8 = users.sub6 OR students.subject9 = users.sub6 OR students.subject10 = users.sub6)
...
<?php
 ...
 $query = "SELECT students.fullname, students.adviser_id, users.sub6,
     ...
     WHERE gender = 'MALE' AND (students.subject6 = '".$_SESSION["sub6"]."' OR students.subject2 = '".$_SESSION["sub6"]."' 
         OR students.subject3 = '".$_SESSION["sub6"]."' OR students.subject4 = '".$_SESSION["sub6"]."' 
         OR students.subject5 = '".$_SESSION["sub6"]."' OR students.subject6 = '".$_SESSION["sub6"]."' 
         OR students.subject7 = '".$_SESSION["sub6"]."' OR students.subject8 = '".$_SESSION["sub6"]."' 
         OR students.subject9 = '".$_SESSION["sub6"]."' OR students.subject10 = '".$_SESSION["sub6"]."')
...
echo "<tr>";
      ...
      echo "<td hidden>";
      echo "<input hidden class='no' id='subjectname' name='subjectname[]' value='" . $_SESSION['sub6'] . "'>";
      echo "</td>";
...
<?php
 ...
 $query = "SELECT students.fullname, students.adviser_id, users.sub6,
     ...
     JOIN users ON 
         ...
         OR users.sec7 = students.section OR users.sec8 = students.section OR users.sec9 = students.section 
         OR users.sec10 = students.section)
     WHERE  gender = 'FEMALE' AND  (students.subject6 = '".$_SESSION["sub6"]."' OR students.subject2 = '".$_SESSION["sub6"]."' 
         OR students.subject3 = '".$_SESSION["sub6"]."' OR students.subject4 = '".$_SESSION["sub6"]."' 
         OR students.subject5 = '".$_SESSION["sub6"]."' OR students.subject6 = '".$_SESSION["sub6"]."' 
         OR students.subject7 = '".$_SESSION["sub6"]."' OR students.subject8 = '".$_SESSION["sub6"]."' 
         OR students.subject9 = '".$_SESSION["sub6"]."' OR students.subject10 = '".$_SESSION["sub6"]."')
...
<img style="width:30px;" src="img/ok.png" class="img-fluid rotate-on-hover" alt="submit">
          ...
          onclick="location.href='subject6view.php'">
