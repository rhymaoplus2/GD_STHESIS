...
rotateBtn.addEventListener("click", () => {
  ...
  $query = "SELECT s.id, s.studentname, s.subjectname, s.grade, s.teacher, s.section, s.adviser, u.name, u.sub1, u.sec1, u.sgh1, s.remarks, s.quarter, s.semester, s.gender
  FROM students s
  JOIN users u ON s.subjectname IN (u.sub1, u.sub2, u.sub3, u.sub4, u.sub5, u.sub6, u.sub7, u.sub8, u.sub9, u.sub10) AND s.section IN (u.sec1, u.sec2, u.sec3, u.sec4, u.sec5, u.sec6, u.sec7, u.sec8, u.sec9, u.sec10)
  WHERE s.teacher = u.name AND s.adviser = u.sgh1";
