  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button type="button" class="btn btn-primary" onclick="window.open('sub4p1.php', '_blank')">1</button>
        <button type="button" class="btn btn-secondary" onclick="window.open('sub4p2.php', '_blank')">2</button>
        <br>
        <h3> Semester 2 - Quarter : </h3>
       
        <button type="button" class="btn btn-success" onclick="window.open('sub4p3.php', '_blank')">3</button>
        <button type="button" class="btn btn-danger" onclick="window.open('sub4p4.php', '_blank')">4</button>
      </div>
    </div>
  </div>
</div>
...
<div class="col-md-1 mb-3">
      <a class="link-primary me-2" href="subject4.php" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-class="tooltip" title="Add Grades">
...
<div class="mx-auto text-center text-wrap mb-3 text-white rounded-pill shadow" style="padding: 10px; background-image: linear-gradient(-20deg, #b721ff 0%, #21d4fd 100%);">
  <b style="white-space: nowrap;"> Students Grades in Subject: <?php echo substr($_SESSION['sub4'], 0, 30); ?> </b>
</div>
...
a.name AS user_name, a.sub4 AS user_sub4, a.sec1, a.sgh1, b.remarks, b.quarter, b.semester, b.sy
FROM grade b, users a
WHERE REPLACE(LOWER(b.subjectname), ' ', '') = REPLACE(LOWER('{$_SESSION['sub4']}'), ' ', '')
AND REPLACE(LOWER(b.teacher), ' ', '') = REPLACE(LOWER('$name'), ' ', '')
AND REPLACE(LOWER(a.sub4), ' ', '') = REPLACE(LOWER('{$_SESSION['sub4']}'), ' ', '')
...
<div>
          <script>
		function printPage() {
			window.open("printsubject4.php", "_blank");
		}
	</script>
<bR>
