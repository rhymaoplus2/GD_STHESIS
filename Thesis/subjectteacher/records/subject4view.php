...
$query = "SELECT b.id, b.studentname, b.subjectname, b.grade, b.teacher, b.section, b.adviser, b.gender, b.status,
    a.name AS user_name, a.sub4 AS user_sub4, a.sec1, a.sgh1, b.remarks, b.quarter, b.semester, b.sy,b.success
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       Grade in    <b> <?php echo $rows['subjectname']; ?> </b> ?
        ...
        <form class="delete" action="delete_grade4.php" method="POST">
