...
<?php
 ...
 $query = "SELECT students.fullname, students.adviser_id, users.sub7,
     ...
     WHERE gender = 'MALE' AND (students.subject7 = '".$_SESSION["sub7"]."' OR students.subject2 = '".$_SESSION["sub7"]."' 
...
<?php
 ...
 $query = "SELECT students.fullname, students.adviser_id, users.sub7,
     ...
     JOIN users ON 
         ...
         OR users.sec7 = students.section OR users.sec8 = students.section OR users.sec9 = students.section 
         OR users.sec10 = students.section)
     WHERE  gender = 'FEMALE' AND  (students.subject7 = '".$_SESSION["sub7"]."' OR students.subject2 = '".$_SESSION["sub7"]."' 
         OR students.subject3 = '".$_SESSION["sub7"]."' OR students.subject4 = '".$_SESSION["sub7"]."' 
         OR students.subject5 = '".$_SESSION["sub7"]."' OR students.subject6 = '".$_SESSION["sub7"]."' 
         OR students.subject7 = '".$_SESSION["sub7"]."' OR students.subject8 = '".$_SESSION["sub7"]."' 
         OR students.subject9 = '".$_SESSION["sub7"]."' OR students.subject10 = '".$_SESSION["sub7"]."')
