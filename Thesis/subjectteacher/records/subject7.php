...
<head>
  ...
  <script>
		function printPage() {
			window.location.href = "printsubject7.php";
		}
	</script>
...
<form action="./php/subject7create.php"
      method="post" >
...
$i = 0;
    while ($rows = mysqli_fetch_assoc($result)) {
      ...
      <?php
        ...
        $name = $_SESSION["name"];
        $query = "SELECT students.fullname, students.adviser_id, users.sub7,
            ...
            WHERE (students.subject1 = users.sub7 OR students.subject2 = users.sub7 OR students.subject3 = users.sub7 OR students.subject4 = users.sub7 OR students.subject5 = users.sub7 OR students.subject6 = users.sub7 OR students.subject7 = users.sub7 OR students.subject8 = users.sub7 OR students.subject9 = users.sub7 OR students.subject10 = users.sub7)
...
require "php/db_conn.php";
 ...
 WHERE gender = 'MALE' AND (students.subject1 = '".$_SESSION["sub7"]."' OR students.subject2 = '".$_SESSION["sub7"]."' 
     OR students.subject3 = '".$_SESSION["sub7"]."' OR students.subject4 = '".$_SESSION["sub7"]."' 
     OR students.subject5 = '".$_SESSION["sub7"]."' OR students.subject6 = '".$_SESSION["sub7"]."' 
     OR students.subject7 = '".$_SESSION["sub7"]."' OR students.subject8 = '".$_SESSION["sub7"]."' 
     OR students.subject9 = '".$_SESSION["sub7"]."' OR students.subject10 = '".$_SESSION["sub7"]."')
...
ORDER BY students.lastname ASC";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($Row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td hidden>";
                echo "<input hidden class='no' id='subjectname' name='subjectname[]' value='" . $_SESSION['sub7'] . "'>";
                echo "</td>";
...
<?php
 ...
 JOIN users ON 
     ...
     OR users.sec7 = students.section OR users.sec8 = students.section OR users.sec9 = students.section 
     OR users.sec10 = students.section)
 WHERE gender = 'FEMALE' AND (students.subject1 = '".$_SESSION["sub7"]."' OR students.subject2 = '".$_SESSION["sub7"]."' 
     OR students.subject3 = '".$_SESSION["sub7"]."' OR students.subject4 = '".$_SESSION["sub7"]."' 
     OR students.subject5 = '".$_SESSION["sub7"]."' OR students.subject6 = '".$_SESSION["sub7"]."' 
     OR students.subject7 = '".$_SESSION["sub7"]."' OR students.subject8 = '".$_SESSION["sub7"]."' 
     OR students.subject9 = '".$_SESSION["sub7"]."' OR students.subject10 = '".$_SESSION["sub7"]."')
...
<img style="width:30px;" src="img/ok.png" class="img-fluid rotate-on-hover" alt="submit">
          ...
          onclick="location.href='subject7view.php'">
