...
<head>
  ...
  <script>
		function printPage() {
			window.location.href = "printsubject10.php";
		}
	</script>
...
<form action="./php/subject10create.php"
      method="post" >
  ...
  <script>
    ...
    $query = "SELECT students.fullname, students.adviser_id, users.sub10,
            ...
            WHERE (students.subject10 = users.sub10 OR students.subject2 = users.sub10 OR students.subject3 = users.sub10 OR students.subject10 = users.sub10 OR students.subject5 = users.sub10 OR students.subject6 = users.sub10 OR students.subject7 = users.sub10 OR students.subject8 = users.sub10 OR students.subject9 = users.sub10 OR students.subject10 = users.sub10)
...
<?php
 ...
 $query = "SELECT students.fullname, students.adviser_id, users.sub10,
     ...
     WHERE gender = 'MALE' AND (students.subject10 = '".$_SESSION["sub10"]."' OR students.subject2 = '".$_SESSION["sub10"]."' 
         OR students.subject3 = '".$_SESSION["sub10"]."' OR students.subject10 = '".$_SESSION["sub10"]."' 
...
<?php
 ...
 $query = "SELECT students.fullname, students.adviser_id, users.sub10,
     ...
     JOIN users ON 
         ...
         OR users.sec7 = students.section OR users.sec8 = students.section OR users.sec9 = students.section 
         OR users.sec10 = students.section)
     WHERE  gender = 'FEMALE' AND  (students.subject10 = '".$_SESSION["sub10"]."' OR students.subject2 = '".$_SESSION["sub10"]."' 
         OR students.subject3 = '".$_SESSION["sub10"]."' OR students.subject10 = '".$_SESSION["sub10"]."' 
         OR students.subject5 = '".$_SESSION["sub10"]."' OR students.subject6 = '".$_SESSION["sub10"]."' 
         OR students.subject7 = '".$_SESSION["sub10"]."' OR students.subject8 = '".$_SESSION["sub10"]."' 
         OR students.subject9 = '".$_SESSION["sub10"]."' OR students.subject10 = '".$_SESSION["sub10"]."')
