...
// Prepare the query
$query = "SELECT DISTINCT b.id, b.fullname, b.syear,b.subject1, b.grade, b.subjectteacher1, b.section,b.trackstrand,a.sub2,a.name
FROM students b
INNER JOIN users a ON 
REPLACE(LOWER(a.sub2), ' ', '') = REPLACE(LOWER(b.subject2), ' ', '') OR
REPLACE(LOWER(a.sub2), ' ', '') = REPLACE(LOWER(b.subject3), ' ', '')  OR
REPLACE(LOWER(a.sub2), ' ', '') = REPLACE(LOWER(b.subject4), ' ', '')  OR
REPLACE(LOWER(a.sub2), ' ', '') = REPLACE(LOWER(b.subject5), ' ', '')  OR
REPLACE(LOWER(a.sub2), ' ', '') = REPLACE(LOWER(b.subject6), ' ', '')  OR
REPLACE(LOWER(a.sub2), ' ', '') = REPLACE(LOWER(b.subject7), ' ', '')  OR
REPLACE(LOWER(a.sub2), ' ', '') = REPLACE(LOWER(b.subject8), ' ', '')  OR
REPLACE(LOWER(a.sub2), ' ', '') = REPLACE(LOWER(b.subject9), ' ', '')  OR
REPLACE(LOWER(a.sub2), ' ', '') = REPLACE(LOWER(b.subject10), ' ', '')  AND
 (
...
if ($Row = mysqli_fetch_assoc($result)) {
  $output_left = "<div id=''>";
  $output_left .= "<p>";
  $output_left .= "<b><h4>".$Row['sub2']."</b> Masterlist</h4><br>" ; 
