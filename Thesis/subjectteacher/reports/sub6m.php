...
// Prepare the query
$query = "SELECT DISTINCT b.id, b.fullname, b.syear,b.subject1, b.grade, b.subjectteacher1, b.section,b.trackstrand,a.sub6,a.name
FROM students b
INNER JOIN users a ON 
REPLACE(LOWER(a.sub6), ' ', '') = REPLACE(LOWER(b.subject2), ' ', '') OR
REPLACE(LOWER(a.sub6), ' ', '') = REPLACE(LOWER(b.subject3), ' ', '')  OR
REPLACE(LOWER(a.sub6), ' ', '') = REPLACE(LOWER(b.subject4), ' ', '')  OR
REPLACE(LOWER(a.sub6), ' ', '') = REPLACE(LOWER(b.subject5), ' ', '')  OR
REPLACE(LOWER(a.sub6), ' ', '') = REPLACE(LOWER(b.subject6), ' ', '')  OR
REPLACE(LOWER(a.sub6), ' ', '') = REPLACE(LOWER(b.subject7), ' ', '')  OR
REPLACE(LOWER(a.sub6), ' ', '') = REPLACE(LOWER(b.subject8), ' ', '')  OR
REPLACE(LOWER(a.sub6), ' ', '') = REPLACE(LOWER(b.subject9), ' ', '')  OR
REPLACE(LOWER(a.sub6), ' ', '') = REPLACE(LOWER(b.subject10), ' ', '')  AND
 (
...
if ($Row = mysqli_fetch_assoc($result)) {
  $output_left = "<div id=''>";
  $output_left .= "<p>";
  $output_left .= "<b><h4>".$Row['sub6']."</b> Masterlist</h4><br>" ; 
...
a.name, a.sub6, a.sec1, a.sgh1, b.gender, b.quarter,
b.firstname, b.middlename, b.lastname, b.remarks
FROM grade b
INNER JOIN users a ON a.sub6 = b.subjectname AND (b.section = a.sec1 OR b.section = a.sec2 OR b.section = a.sec3 OR b.section = a.sec4 OR b.section = a.sec5 OR b.section = a.sec6 OR b.section = a.sec7 OR b.section = a.sec8 OR b.section = a.sec9 OR b.section = a.sec10)
