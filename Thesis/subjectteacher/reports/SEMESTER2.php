...
<div>
    <div  style="	box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
     border-radius:20px;  background-image: linear-gradient(-20deg, #b721ff 0%, #21d4fd 100%);" class="mb-3 text-white text-center"><h4>SHS SECOND SEMESTER PRINTABLE GRADES </h4></div>
</div>  
...
FROM grade 
WHERE semester = 'SECOND'     AND teacher = '" . $_SESSION['name'] . "'
